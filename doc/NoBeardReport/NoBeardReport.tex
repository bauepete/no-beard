...
March 7, 2019 & P. Bauer &  {\bf Released v. 2.0} \\ \hline
March 6, 2019 & P. Bauer & Updated naming schemes for NoBeard identifiers and Assembler labels. Documentation of assembler instruction \verb$in$ is corrected. \\ \hline
...
\subsection{Token Classes}
\begin{description}
	\item [identifier] \verb1(letter | '_' | '$'){letter | digit | '_' | '$'}1
