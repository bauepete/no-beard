...
\lstdefinelanguage{NoBeardAsm}{
	...
	sensitive=true,
	tabsize=3,
	morekeywords = {nop, lit, la, lv, lc, sto, stc, assn, neg, add, sub, mul, div, mod, not, rel, fjmp, tjmp, jmp, in, out, inc, halt, break, push, pop, printf, dat, prog, top, fp, pc, ms, ProgramAddressError, running, stopped, blocked, error},
